...
def format(filename):
    ...
    #print "this is the file data {}".format(file_data_list)
...
def unique_houses(filename):
    ...
    """
    file_data = format(filename)

    houses = set([line[2] for line in file_data if line[2] != ''])
    return houses
...
def sort_by_cohort(filename):
    ...
    #print [winter_16, spring_16, summer_16, fall_15, ghosts]
...
def hogwarts_by_house(filename):
    ...
    return [gryffindor, slytherin, hufflepuff, ravenclaw, dumbledores_army, ghosts, instructors]
...
sorted_list = sort_by_cohort("cohort_data.txt")
